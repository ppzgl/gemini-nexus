...
describe('connection settings helpers', () => {
    it('builds the default connection payload used by sidepanel restore messages', () => {
        expect(createConnectionSettingsPayload({})).toEqual({
            ...
            apiKey: '',
            officialModel: 'gemini-3.8-flash, gemini-3.5-flash-lite, gemini-3.1-pro',
            thinkingLevel: 'low',
            ...
            dedicatedApiProviders: {
                openai_official: {
                    ...
                    apiKey: '',
                    model: 'gpt-5.6-terra, gpt-5.6-sol, gpt-5.6-luna, gpt-6-astra',
                    selectedModel: '',
                    thinkingLevel: 'low',
                    webSearch: false,
                    providerRouting: '',
                ...
                openrouter: {
                    ...
                    apiKey: '',
                    model: 'openai/gpt-5.6-terra, anthropic/claude-sonnet-5, google/gemini-3.1-pro, deepseek/deepseek-v4-flash',
                    selectedModel: '',
                    thinkingLevel: 'low',
                    webSearch: false,
                    providerRouting: '',
                ...
                dashscope: {
                    ...
                    apiKey: '',
                    model: 'qwen3.8-max, qwen3.8-flash-next, qwen3.7-max, qwen3-vl-plus, qwq-plus',
                    selectedModel: '',
                    thinkingLevel: 'low',
                    webSearch: false,
                    providerRouting: '',
                ...
                anthropic: {
                    ...
                    apiKey: '',
                    model: 'claude-sonnet-5, claude-opus-5, claude-fable-5-1, claude-haiku-4-5',
                    selectedModel: '',
                    thinkingLevel: 'low',
                    webSearch: false,
                    providerRouting: '',
                ...
                zhipu: {
                    ...
                    apiKey: '',
                    model: 'glm-5.3, glm-5.2, glm-5.1, glm-5',
                    selectedModel: '',
                    thinkingLevel: 'low',
                    webSearch: false,
                    providerRouting: '',
